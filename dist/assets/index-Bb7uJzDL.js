const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/SearchPage-Dt3-aWqY.js', 'assets/SearchPage-gcOR0FE5.css'])
) => i.map((i) => d[i]);
(function () {
...
const h0 = () =>
  ...
  m0 = D.lazy(() =>
    Dc(() => import('./SearchPage-Dt3-aWqY.js'), __vite__mapDeps([0, 1]))
  ),
  y0 = D.lazy(() => Dc(() => import('./About-Q4pmrhjS.js'), [])),
  v0 = D.lazy(() => Dc(() => import('./NotFound-Cl20Xis0.js'), []));
function g0() {
  return zt.jsx(a0, {
    basename: '/react-rss/',

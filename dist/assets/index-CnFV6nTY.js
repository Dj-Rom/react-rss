...
function Uy() {
  ...
  return ((me.Fragment = G), (me.jsx = Q), (me.jsxs = Q), me);
}
var Fd;
function Ry() {
...
function Hy() {
  ...
  function Hl(s, A, M, z, N) {
        ...
        case 'object':
          switch (s.$$typeof) {
            ...
            case G:
              ...
              break;
            case H:
              return ((x = s._init), Hl(x(s._payload), A, M, z, N));
          }
      }
    if (x)
      return (
    ...
    if (ht(s))
      for (var sl = 0; sl < s.length; sl++)
        ((z = s[sl]), (W = Jl + Rl(z, sl)), (x += Hl(z, A, M, W, N)));
    else if (((sl = fl(s)), typeof sl == 'function'))
      for (s = sl.call(s), sl = 0; !(z = s.next()).done; )
        ((z = z.value), (W = Jl + Rl(z, sl++)), (x += Hl(z, A, M, W, N)));
    else if (W === 'object') {
      if (typeof s.then == 'function') return Hl(ou(s), A, M, z, N);
      throw (
        (A = String(s)),
        Error(
  ...
  return (
    ...
    (j.createElement = function (s, A, M) {
      ...
      if (s && s.defaultProps)
        for (z in ((x = s.defaultProps), x)) N[z] === void 0 && (N[z] = x[z]);
        ...
        function ht(g) {
          for (var _ = Q(T); _ !== null; ) {
            if (_.callback === null) m(T);
              ...
              (m(T), (_.sortIndex = _.expirationTime), G(R, _));
            else break;
            _ = Q(T);
          }
        }
...
var tv;
function py() {
  return (tv || ((tv = 1), (Pc.exports = Ny())), Pc.exports);
}
var ti = { exports: {} },
  ql = {};
/**
...
function By() {
  ...
  var Hl = Array.isArray,
    g = G.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  ...
  var N = A(null),
    ...
    Jl = A(null);
  function sl(l, t) {
    switch ((z(x, t), z(W, l), z(N, null), t.nodeType)) {
      case 9:
      case 11:
  ...
  var Zt = Math.random().toString(36).slice(2),
    ...
    Aa = '__reactMarker$' + Zt;
  function Zn(l) {
    (delete l[Nl], delete l[Xl], delete l[Cn], delete l[gv], delete l[bv]);
  }
  function Bu(l) {
    var t = l[Nl];
    if (t) return t;
...
` +
  ...
  var Su = {
    ...
    Hi = Ql(pe),
    Rv = H({}, pe, { dataTransfer: 0 }),
    Hv = Ql(Rv),
    Nv = H({}, Ma, { relatedTarget: 0 }),
    uf = Ql(Nv),
    pv = H({}, Su, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    qv = Ql(pv),
    Yv = H({}, Su, {
          ...
          l: {
            ...
            switch (p.tag) {
              ...
              case 0:
                if (
                  ((B = p.payload),
                  (o = typeof B == 'function' ? B.call(ul, E, o) : B),
                  o == null)
                )
                  break l;
                E = H({}, E, o);
  ...
  function f0(l) {
    ...
    function ul(v, d, h, b) {
      if (
        ...
        if (Hl(h)) return B(v, d, h, b);
        if (Rl(h)) {
          if (((D = Rl(h)), typeof D != 'function')) throw Error(m(150));
          return ((h = D.call(h)), p(v, d, h, b));
        }
  ...
  function _0(l, t, u, a, e) {
    if ((Mu(t), t.stateNode === null)) {
      ...
      var y = n.context,
        S = u.contextType;
      ((f = $u), typeof S == 'object' && S !== null && (f = pl(S)));
  ...
  function tt(l, t, u) {
    (((l === cl && (P === 2 || P === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ta(l, u),
      ((I & 2) === 0 || l !== cl) &&
        (l === cl && ((I & 2) === 0 && (Nu |= u), yl === 4 && eu(l, J, st, !1)),
        At(l)));
  }
  function F0(l, t, u) {
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = Sc + 300 - St()), 10 < e)) {
            ...
            a.timeoutHandle = Md(
              I0.bind(null, a, u, Zl, hn, mc, t, st, Nu, sa, lu, n, 2, -0, 0),
              e
            );
            break l;
          }
          I0(a, u, Zl, hn, mc, t, st, Nu, sa, lu, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
        ...
        if (P !== 0 && V !== null) {
          ...
          switch (P) {
            ...
            case 6:
              it.current === null && (t = !0);
              var y = P;
              if (((P = 0), (Pl = null), ya(l, c, i, y), u && ia)) {
                f = 0;
                break l;
              }
              break;
            default:
              ((y = P), (P = 0), (Pl = null), ya(l, c, i, y));
          }
        }
        (xh(), (f = yl));
        break;
  ...
  function ad(l) {
    ...
    switch (t.tag) {
      ...
      case 5:
        Xf(t);
      default:
        (N0(u, t), (t = V = es(t, Xt)), (t = R0(u, t, Xt)));
    }
    ((l.memoizedProps = l.pendingProps), t === null ? on(l) : (V = t));
  }
  function ya(l, t, u, a) {
    ...
    Di(function () {
      ...
      l: {
        ...
        if (o !== void 0) {
          ...
          for (var d = y, h; d !== null; ) {
            ...
            if (
              ...
              (b !== 5 && b !== 26 && b !== 27) ||
                h === null ||
                v === null ||
                ((b = _a(d, v)), b != null && p.push(fe(d, b, h))),
              ul)
            )
              break;
            d = d.return;
          ...
          0 < p.length &&
            ((o = new r(o, B, null, u, S)), E.push({ event: o, listeners: p }));
        }
      }
      if ((t & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              (ul = r == null ? o : za(r)),
              (h = B == null ? o : za(B)),
              (o = new p(b, d + 'leave', r, u, S)),
              (o.target = ul),
              (o.relatedTarget = h),
              (b = null),
              Bu(S) === y &&
                ((p = new p(v, d + 'enter', B, u, S)),
                (p.target = h),
                (p.relatedTarget = ul),
                (b = p)),
              (ul = b),
              ...
              t: {
                for (p = r, v = B, d = 0, h = p; h; h = ra(h)) d++;
...
`
  ...
  function cy(l) {
    (Qt.D(l), pd('dns-prefetch', l, null));
  }
  function iy(l, t) {
    (Qt.C(l, t), pd('preconnect', l, t));
  }
  function sy(l, t, u) {
    Qt.L(l, t, u);
    var a = ma;
  ...
  function Kc(l, t, u, a) {
    if (Dn) {
      var e = Jc(a);
      if (e === null) (pc(l, t, a, Un, u), Kd(l, a));
...
class Xy extends vu.Component {
  ...
  componentDidCatch(G, Q) {
    console.error('Caught by ErrorBoundary:', G, Q);
  }
  handleReset = () => {
  ...
  render() {
    return this.state.hasError
      ? F.jsxs('div', {
          children: [
            F.jsx('h1', { children: 'Something went wrong.' }),
            F.jsx('button', {
...
class Qy extends vu.Component {
  ...
  handleChange = (G) => {
    this.setState({ input: G.target.value });
  };
  handleSubmit = (G) => {
    (G.preventDefault(), this.props.onSearch(this.state.input.trim()));
  };
  render() {
    return F.jsxs('form', {
      ...
      children: [
        ...
        F.jsx('button', { type: 'submit', children: 'Search' }),
      ],
    });
  }
}
const jy = '_header_nquqf_1',
  Cy = { header: jy };
...
const Vy = '_main_er118_1',
  Ly = '_cardList_er118_12',
  Ky = '_card_er118_12',
...
class Jy extends vu.Component {
  render() {
    return F.jsxs('div', {
      className: ai.card,
      children: [
        F.jsx('h3', { children: this.props.name }),
        F.jsx('p', { children: this.props.description }),
      ],
    });
  }
}
class wy extends vu.Component {
  render() {
    return F.jsx('div', {
      ...
      children: this.props.items.map((G) =>
        F.jsx(Jy, { name: G.name, description: G.description }, Math.random())
      ),
    });
  }
}
const Wy = ({ onClick: O }) =>
  ...
  $y = () =>
    F.jsx('div', {
      style: { margin: ' 0 auto', fontSize: '200%', zIndex: 1, color: 'green' },
      children: 'Loading...',
    });
class ky extends vu.Component {
  render() {
    const { items: G, loading: Q, error: m, onTriggerError: X } = this.props;
    return F.jsxs('main', {
      className: ai.main,
      children: [
        Q
          ...
          : !Q && !m && G.length > 0
            ...
            : Q
              ? null
              : F.jsx('h2', {
                  children: 'Could not find the requested Pokémon',
                }),
        F.jsx(Wy, { onClick: X }),
      ],
    });
...
class Fy extends vu.Component {
  ...
  fetchItems = async (G) => {
    ...
    const K = (await m.json()).results.filter((nl) =>
      nl.name.startsWith(G.trim().toLowerCase())
    );
  ...
  loadItems = async (G) => {
    this.setState({ loading: !0, error: null, hasError: !1 });
    try {
      const Q = await this.fetchItems(G);
      this.setState({ items: Q, loading: !1, hasError: !1 });
    } catch (Q) {
      this.setState({ error: Q.message, loading: !1, hasError: !0 });
    }
  };
  handleSearch = (G) => {
    (localStorage.setItem('searchQuery', G),
      this.setState({ query: G }, () => this.loadItems(G)));
  };
  triggerError = () => {
  ...
  render() {
    ...
    return G
      ? F.jsxs('div', {
          children: [
            F.jsx('h2', { children: 'Something went wrong.' }),
            F.jsx('button', {
      ...
      : F.jsxs(F.Fragment, {
          children: [
            F.jsx(Zy, { value: Q, onSearch: this.handleSearch }),
            F.jsx(ky, {
              items: m,
              loading: X,
              error: K,
...
const Iy = document.getElementById('root'),
  Py = Gy.createRoot(Iy);
Py.render(
  F.jsx(vu.StrictMode, { children: F.jsx(Xy, { children: F.jsx(Fy, {}) }) })
);

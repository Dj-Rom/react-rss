    ...
    return (
        <form ref={formRef} onSubmit={handleSubmit} className="form">
            <div className="form-group">
                ...
                />
                {errors.name && <span data-testid="name-error" className="error-message">{errors.name}</span>}
            </div>
            ...
            <div className="form-group">
                ...
                />
                {errors.age && <span data-testid="age-error" className="error-message">{errors.age}</span>}
            </div>
            ...
            <div className="form-group">
                ...
                {errors.gender && <span data-testid="gender-error" className="error-message">{errors.gender}</span>}
            </div>
            ...
            <div className="form-group">
                ...
                {errors.country && <span data-testid="country-error" className="error-message">{errors.country}</span>}
            </div>
            ...
            <div className="form-group">
                ...
                />
                {errors.photo && <span data-testid="photo-error" className="error-message">{errors.photo}</span>}
            </div>

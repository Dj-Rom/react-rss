...
describe('UncontrolledForm', () => {
    ...
    beforeEach(() => {
        ...
        vi.stubGlobal('FileReader', class implements FileReader {
    ...
    it('renders all fields', () => {
        ...
        expect(screen.getByRole('checkbox', { name: /terms of use/i })).toBeInTheDocument()
    ...
    it('shows validation errors on empty submit', async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByTestId('gender-error')).toHaveTextContent(/Select gender/)
            expect(screen.getByTestId('country-error')).toHaveTextContent(/Select a country/)
            expect(screen.getByTestId('photo-error')).toHaveTextContent(/Unsupported file format/)
        })
    ...
    it('submits valid data', async () => {
        ...
        fireEvent.input(screen.getByLabelText(/^Password$/i), { target: { value: 'Aa1!aaaa' } })
        fireEvent.input(screen.getByLabelText('Confirm Password'), { target: { value: 'Aa1!aaaa' } })
